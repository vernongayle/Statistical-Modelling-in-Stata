...
This model has first to be installed from the scc repository.
...
* estimate a regression model of math score (math) and ethnicity *
...
Notice that these models are equivalent however the reference category for
...
regress math ib4.race, allbaselevels
...
If esttab it not installed on you machine 

type and run

"ssc install estout, replace"

If you are having problems then ask for help.
...
esttab reg1 using "f:\regress1.rtf",  ///
 se stats(r2 r2_a N, fmt(%9.2f %9.2f) labels(R-Squared AdjR-Squared n)) wide ///
